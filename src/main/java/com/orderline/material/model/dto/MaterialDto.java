...
public class MaterialDto {
    ...
    public static class ResponseMaterialDto {
        ...
        @ApiModelProperty(value = "판매가", example = "8000")
    ...
    public static class RequestCreateMaterialDto {
        ...
        public Material toEntity(Order order, Product product) {
    ...
    @Getter
    @Builder
    public static class ResponseMaterialHistoryDto {
        @ApiModelProperty(value = "자재 ID", example = "1")
        ...
        public static ResponseMaterialHistoryDto toDto(MaterialHistory materialHistory) {
            return ResponseMaterialHistoryDto.builder()
                    .materialId(materialHistory.getMaterialId())
                    .name(materialHistory.getName())
                    .quantity(materialHistory.getQuantity())
                    .status(materialHistory.getStatus())
                    .totalPrice(materialHistory.getTotalPrice())
                    .specifics(materialHistory.getSpecifics())
                    .requestDt(materialHistory.getRequestDt().toEpochSecond())
                    .expectedDt(materialHistory.getExpectedDt().toEpochSecond())
                    .build();
        }
    }
    ...
    @Getter
    @Builder
    public static class ResponseMaterialHistoryListDto {

            @ApiModelProperty(value = "자재 이력 목록")
            private List<ResponseMaterialHistoryDto> results;
            ...
            public static ResponseMaterialHistoryListDto build(Page<ResponseMaterialHistoryDto> responseDtoPage, Integer currentPage, Integer maxResults) {
                return ResponseMaterialHistoryListDto.builder()
                        .results(responseDtoPage.getContent())
                        .maxResults(maxResults)
                        .currentPage(currentPage)
                        .totalPages(responseDtoPage.getTotalPages())
