package com.ptglue.admin.user_qa_comment.model.dto;

import com.fasterxml.jackson.annotation.JsonInclude;
import com.ptglue.admin.user_qa_comment.model.entity.UserQaComment;
import com.ptglue.basic.enums.QaDetailTypeEnum;
import com.ptglue.basic.enums.QaTypeEnum;
import com.ptglue.common.user_qa.model.entity.UserQa;
...
public class UserQaCommentDto {
    ...
    public static class ResponseUserQaDto {
        ...
        @ApiModelProperty(value = "문의 고객 정보")
        private User user;
    ...
    public static class RequestUserQaDto{
        ...
        @ApiModelProperty(value = "유저", example = "1")
        @NotBlank(message = "유저 를 입력해주세요.")
        private User user;

        @ApiModelProperty(value = "질문 타입", example = "1")
        @NotBlank(message = "질문 타입을 입력해주세요.")
        private QaTypeEnum qaType;

        @ApiModelProperty(value = "질문 세부 타입", example = "7")
        @NotBlank(message = "질문 세부 정보를 입력해주세요.")
        private QaDetailTypeEnum qaDetailType;
        ...
        public UserQa toEntity(User user, RequestUserQaDto createUserQaRequest){
    ...
    public static class ResponseUserQaListDto {
        ...
        public static ResponseUserQaListDto build(Page<ResponseUserQaDto> responseDtoPage, Integer currentPage, Integer maxResults){
            return ResponseUserQaListDto.builder()
    ...
    @Getter
    @Builder
    public static class RequestUserQaCommentDto {

        @ApiModelProperty(value = "답변 제목")
        @NotNull(message = "답변 제목을 입력해주세요.")
        private String title;
        ...
        public UserQaComment toEntity(UserQa userQa, RequestUserQaCommentDto createUserQaCommentRequest){
            return UserQaComment.builder()
                    .userQa(userQa)
                    .title(createUserQaCommentRequest.getTitle())
                    .contents(createUserQaCommentRequest.getContents())
                    .build();
        }
    }
    ...
    public static class ResponseUserQaCommentListDto {
        ...
        public static ResponseUserQaCommentListDto build(Page<ResponseUserQaCommentDto> responseDtoPage, Integer currentPage, Integer maxResults){
            return ResponseUserQaCommentListDto.builder()
                    .results(responseDtoPage.getContent())
                    .maxResults(maxResults)
                    .currentPage(currentPage)
                    .totalPages(responseDtoPage.getTotalPages())
